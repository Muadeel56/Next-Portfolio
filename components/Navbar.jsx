...
const Navbar = () => {
  ...
  return (
    ...
    <div className="fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]">
      <Image src={assets.header_bg_color} alt="header" className="md:hidden cursor-pointer" />
    </div>
      <nav className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50">
        ...
        <div className="flex items-center">
          ...
          <a href="#contact" className="hidden lg:flex items-center font-Ovo gap-3 px-10 py-2.5 border border-gray-500 rounded-full
          ml-4">
            Contact{" "}
